...
export default function SignIn() {
  ...
  return (
    <div class="fixed dark:bg-gray-600 inset-0 flex items-center justify-center">
    <div className="max-w-md w-full space-y-8 p-8 dark:bg-gray-800 rounded-xl shadow-lg">
